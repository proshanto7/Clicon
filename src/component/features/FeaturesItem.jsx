function FeaturesItem({ item }) {
  ...
  return (
    <div className=" flex text-lightGray border lg:border-none w-full items-center gap-4 py-8.5 px-8 hover:bg-primaryOrenge hover:text-white duration-300 cursor-pointer rounded-md">
